...
public class ModelDreadLich extends ModelDragonBase {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        EntityDreadLich lich = (EntityDreadLich) entityIn;
        ...
        if (lich.getAnimation() == EntityDreadLich.ANIMATION_SPAWN) {
            if (lich.getAnimationTick() < 30) {
                this.flap(armRight, 0.5F, 0.5F, false, 2, -0.7F, lich.ticksExisted, 1);
                this.flap(armLeft, 0.5F, 0.5F, true, 2, -0.7F, lich.ticksExisted, 1);
                this.walk(armRight, 0.5F, 0.5F, true, 1, 0, lich.ticksExisted, 1);
                this.walk(armLeft, 0.5F, 0.5F, true, 1, 0, lich.ticksExisted, 1);
            }
        }
        if (lich.getAnimation() == EntityDreadLich.ANIMATION_SUMMON) {
