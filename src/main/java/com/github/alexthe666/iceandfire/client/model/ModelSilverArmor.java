...
public class ModelSilverArmor extends ModelBiped {
    ...
    public ModelSilverArmor(float modelSize) {
        ...
        this.robeLowerBack.addBox(-4.0F, 0F, -2.5F, 8, 8, 1, modelSize);
        this.setRotateAngle(robeLowerBack, 0F, 3.141592653589793F, 0F);
        this.crest = new ModelRenderer(this, 18, 32);
        this.crest.setRotationPoint(0F, -7.9F, -0.1F);
        this.crest.addBox(0F, -0.5F, 0F, 1, 9, 9, 0F);
        this.setRotateAngle(crest, 1.2292353921796064F, 0F, 0F);
        this.robeLower = new ModelRenderer(this, 4, 55);
        this.robeLower.setRotationPoint(0F, 12.0F, 0F);
        this.robeLower.addBox(-4.0F, 0F, -2.5F, 8, 8, 1, modelSize);
        this.helmWingR = new ModelRenderer(this, 2, 37);
        this.helmWingR.setRotationPoint(-3.0F, -6.3F, 1.3F);
        this.helmWingR.addBox(-0.5F, -1.0F, 0F, 1, 4, 6, modelSize);
        ...
        this.helmWingL.addBox(-0.5F, -1.0F, 0F, 1, 4, 6, modelSize);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        if (entityIn instanceof EntityArmorStand) {
            ...
            this.bipedHead.setRotationPoint(0F, 1.0F, 0F);
            ...
            this.bipedLeftLeg.setRotationPoint(1.9F, 11.0F, 0F);
            this.bipedRightLeg.rotateAngleX = 0.017453292F * entityarmorstand.getRightLegRotation().getX();
            this.bipedRightLeg.rotateAngleY = 0.017453292F * entityarmorstand.getRightLegRotation().getY();
            this.bipedRightLeg.rotateAngleZ = 0.017453292F * entityarmorstand.getRightLegRotation().getZ();
            this.bipedRightLeg.setRotationPoint(-1.9F, 11.0F, 0F);
