...
public class ModelSilverArmor extends ModelBiped {
    ...
    public ModelSilverArmor(float modelSize) {
        ...
        this.faceGuard.addBox(-4.5F, -3.0F, -6.1F, 9, 9, 8);
        ...
        this.helmWingR.addBox(-0.5F, -1.0F, 0.0F, 1, 4, 6);
        ...
        this.helmWingL.addBox(-0.5F, -1.0F, 0.0F, 1, 4, 6);
        ...
        this.crest.addBox(0.0F, -0.5F, 0.0F, 1, 9, 9);
        ...
        this.robeLowerBack.addBox(-4.0F, 0.0F, -2.5F, 8, 8, 1);
        ...
        this.robeLower.addBox(-4.0F, 0.0F, -2.5F, 8, 8, 1);
